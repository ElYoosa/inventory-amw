...
class RealtimeCollectionExport implements FromCollection, WithHeadings, WithStyles, WithEvents, WithTitle, ShouldAutoSize
{
    ...
    {
        return ['No', 'Type', 'Tanggal', 'Kode Grup', 'Nama Barang', 'Kategori', 'Qty', 'Penerima', 'Catatan'];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('G' . $headerRow . ':G' . $lastRow)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
