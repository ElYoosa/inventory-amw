...
class CategoryController extends Controller
{
  ...
  public function update(Request $r, Category $category)
  {
    try {
      ...
      return redirect()->route("categories.index")->with("successToast", "Kategori berhasil diperbarui!");
    } catch (\Throwable $e) {
      return redirect()
        ->back()
  ...
  public function destroy(Category $category)
  {
    try {
      ...
      return redirect()->route("categories.index")->with("successToast", "Kategori berhasil dihapus!");
    } catch (\Throwable $e) {
      return redirect()
        ->back()
