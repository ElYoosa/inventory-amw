...
class AuthenticatedSessionController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $loginType =
      Schema::hasColumn("users", "username") && !filter_var($request->login, FILTER_VALIDATE_EMAIL)
        ? "username"
        : "email";
    ...
    $messages = [
      ...
      "staff" => [
        "text" =>
          "Hai <strong>Staff</strong> 👋, segera perbarui transaksi barang masuk dan keluar!",
        "color" => "#CA8A04",
        "icon" => "📦",
      ],
    ];
